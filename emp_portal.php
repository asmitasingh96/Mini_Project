...
if (isset($_POST['mark_attendance'])) {
    ...
    if ($check->num_rows == 0) {
        ...
        echo "<script>alert('⚠ Attendance already marked.');window.location='emp_portal.php';</script>";
        exit;
    }
}
?>
...
<div class="app">
  <aside class="sidebar">
    ...
    <nav class="menu">
      ...
      <a href="emp_portal.php" class="<?= $current_page=='emp_portal.php.php'?'active':'' ?>">Meetings</a>
