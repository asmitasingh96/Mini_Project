...
document.getElementById('showFormBtn').addEventListener('click', function() {
  ...
  ?>
            ...
            <td>
              <a class="btn" href="admin_notices.php?action=edit&id=<?= $row['id'] ?>">Edit</a>
              <a class="btn" href="admin_notices.php?toggle=1&id=<?= $row['id'] ?>"><?= $row['is_published'] ? 'Unpublish' : 'Publish' ?></a>
              <a class="btn danger" href="admin_notices.php?action=delete&id=<?= $row['id'] ?>" onclick="return confirm('Delete this notice?')">Delete</a>
            </td>
          </tr>
        <?php endwhile; ?>
