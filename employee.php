...
.menu a.active {
  color: black;
    ...
    .profile-card .photo{width:88px;height:88px;border-radius:50%;background:#fff;overflow:hidden;box-shadow:0 2px 6px rgba(10,30,50,0.06)}
    .profile-card .info{line-height:1.5}
    .profile-card .info h2{font-size:25px;color:#0f3550}
    .profile-card .info small{display:block;color:#17607a}

    /* Welcome box */
    .welcome{background:linear-gradient(90deg,#cfe3ff,#e7f0ff);padding:26px;border-radius:10px;margin-bottom:18px;display:flex;justify-content:space-between;align-items:center}
    .welcome h3{font-size:22px;color:#072b3a}
    .welcome p{opacity:0.8}
    .welcome .hero-img{width:110px;height:110px;border-radius:50%;background:#fff;overflow:hidden;border:6px solid rgba(255,255,255,0.6)}
...
/* Card filtering highlight */
.card.hidden {
  display: none !important;
}

    /* small area */
    .small{color:#6a7f86;font-size:13px;margin-top:10px}
...
<div class="profile-card">
  ...
  <div class="info">
<h2><?php echo $_SESSION['full_name']; ?> (<?php echo $_SESSION['emp_id']; ?>)</h2>
      ...
      <div>
        ...
        <a href="employee_worktimetracking.php" class="card">
        <div class="icon">⏱</div>
        <small>Attendance & Work Time</small>
        </a>
           
 <a href="employee_leave.php" class="card">
        <div class="icon">⏱</div>
        <small>Leave Request</small>
          ...
          <a href="employee_tasks_projects.php" class="card">
        <div class="icon">🗂</div>
 ...
 <a href="employee_news.php" class="card">
        <div class="icon">📰</div>
        <small>News & Notices</small>
        </a>
   
                             
 <a href="employee_profile.php" class= "card">
        <div class="icon">🧾</div>
